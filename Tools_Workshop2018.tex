...
%
\author{Madhura Kumaraswamy \inst{1} \and Anamika Chowdhury \inst{1} \and Andreas Gocht \inst{2} \and Jan Zapletal \inst{5} \and Kai Diethelm \and Lubomir Riha \inst{5} \and Marie-Christine Sawley \inst{6} \and Michael Gerndt \inst{1} \and Nico Reissmann \inst{3} \and Ondrej Vysocky \inst{5} \and Othman Bouizi \inst{6} \and Per Gunnar Kjeldsberg \inst{3}  \and Ramon Carreras \inst{4} \and Robert Sch\"one \inst{2} \and Umbreen Sabir Mian \inst{2} \and Venkatesh Kannan \inst{4}}
%
...
\institute{ Department of Informatics, Technical University of Munich, Bavaria, Germany 
	...
	Intel ExaScale Labs, Paris, France \\ \and
